...
- Una cuenta secundaria de Instagram para extraer las cookies (por seguridad).

## 🔧 Instalación y Configuración

1. **Clonar el repositorio:**
   ```bash
   git clone [https://github.com/tu_usuario/ig-deep-analyzer.git](https://github.com/tu_usuario/ig-deep-analyzer.git)
   cd ig-deep-analyzer